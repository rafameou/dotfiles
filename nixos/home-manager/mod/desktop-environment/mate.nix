...
in
{
  ...
  dconf.settings = {
    ...
    */
    ...
    "org/mate/panel/objects/eyes-applet/prefs".theme-path =
      "${pkgs.mate.mate-applets}/share/mate-applets/geyes/Tango";
  ...
  xdg.configFile = {
    ...
    */
    "autostart/gammastep-indicator.desktop".text =
      autostartString "gammastep-indicator" "OnlyShowIn=MATE;";
    ...
    "autostart/kdeconnect-indicator.desktop".text =
      autostartString "kdeconnect-indicator" "OnlyShowIn=MATE;";
    ...
    "autostart/xscreensaver.desktop".text =
      autostartString "xscreensaver --no-splash" "OnlyShowIn=MATE;";
